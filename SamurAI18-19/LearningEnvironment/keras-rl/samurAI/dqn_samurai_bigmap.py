...
parser.add_argument('--env-name', type=str, default='SamurAI-v1')
...
model.add(Reshape((8, 100, 20), input_shape=(1,) + input_shape))

model.add(Convolution2D(32, (4, 4), strides=(2, 2), padding='same', data_format='channels_first'))
...
if args.mode == 'train':
    ...
    plt.xlabel("Episode")
    plt.ylabel("Reward")
    plt.savefig('0127_learning_curve.fig')
    # plt.show()

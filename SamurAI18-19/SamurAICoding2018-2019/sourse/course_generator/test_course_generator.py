# -*- coding: utf-8 -*-
"""
Created on Sun Oct 21 21:50:25 2018
...
##    print("list1", list1)
#    # validate the stop
#    for i in range(0, len(squares), width):
#        
#        if list1 in squares[i:width]:
#            print("BAD!!")
#        else:
#            #print("OK!")
#            pass
...
#        print("k=", k)
        count = 0
        for i in range(k, len(squares), width):
#            print("i=", i)
...
#        print("length-1", length-1)                        
        if count < length-3: # lengthからstart lineを除く(-1する)。さらに-2
#            print("OK")
            pass
        else:
            print("BAD")        
...
j = 0
for j in range(1):
    print("create course :", j)
    print("vision", vision)
    make_course(width, length, vision, sym)
    j += 1
